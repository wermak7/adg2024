...
ALGORYTM ZnajdzMaks(lista)
  maks = lista[1]
  FOR dla kazdego elementu IN lista:
...
- Niereguralna sieć trójkątów (*TIN*)
- Dane tabelaryczne
- Analiza terenu
...
systemami geoprzestrzennymi za pomocą interfesju programowania aplikacji (*API*).
:::
